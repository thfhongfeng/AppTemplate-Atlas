...
import com.pine.demo.remote.DemoUiRemoteService;
...
public class DemoAtlasUiRemote extends AtlasRouterBundleRemote<DemoUiRemoteService> implements IRemote {
    private static DemoUiRemoteService mRemoteService;
    private static Method[] mMethods;

    static {
        mRemoteService = new DemoUiRemoteService();
