...
public class MvvmAtlasOpRemote extends AtlasRouterBundleRemote<MvvmOpRemoteService> implements IRemote {

    private static MvvmOpRemoteService mRemoteService;
