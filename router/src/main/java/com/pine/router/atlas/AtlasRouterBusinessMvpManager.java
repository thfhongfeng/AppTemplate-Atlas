...
public class AtlasRouterBusinessMvpManager implements IRouterManager {
    private static final String TAG = LogUtils.makeLogTag(AtlasRouterBusinessMvpManager.class);
    ...
    public void callUiCommand(Activity activity, final String commandName, final Bundle args, final IRouterCallback callback) {
        if (!RouterBundleSwitcher.isBundleOpen(RouterBundleKey.BUSINESS_MVP_BUNDLE_KEY)) {
            LogUtils.releaseLog(TAG, RouterBundleKey.BUSINESS_MVP_BUNDLE_KEY + " is not opened");
            if (callback != null) {
        ...
        RemoteFactory.requestRemote(RemoteTransactor.class, activity,
                new Intent("atlas.transaction.intent.action.business.MvpBundleRemoteAction"),
                new RemoteFactory.OnRemoteStateListener<RemoteTransactor>() {
                    ...
                    public void onFailed(String errorInfo) {
                        LogUtils.releaseLog(TAG, "request " + RouterBundleKey.BUSINESS_MVP_BUNDLE_KEY + " onFailed");
                        if (callback != null) {
