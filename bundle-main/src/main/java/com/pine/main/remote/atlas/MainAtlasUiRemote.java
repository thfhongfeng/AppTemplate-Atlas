...
public class MainAtlasUiRemote extends AtlasRouterBundleRemote<MainUiRemoteService> implements IRemote {

    private static MainUiRemoteService mRemoteService;
