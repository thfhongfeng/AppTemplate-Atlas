...
public class GPSUtils {
    ...
    public static double getDistance(double startLatitude, double startLongitude, double endLatitude, double endLongitude) {
        double radLat1 = toRadius(startLatitude);
        double radLat2 = toRadius(endLatitude);
        double a = radLat1 - radLat2;
        double b = toRadius(startLongitude) - toRadius(endLongitude);
    ...
    private static double toRadius(double d) {
