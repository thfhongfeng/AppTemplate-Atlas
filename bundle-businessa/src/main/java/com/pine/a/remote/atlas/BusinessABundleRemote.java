...
public class BusinessABundleRemote implements IRemote {

    private static BusinessABundleRemoteService mRemoteService;
    private static Method[] mMethods;

    static {
        mRemoteService = new BusinessABundleRemoteService();
